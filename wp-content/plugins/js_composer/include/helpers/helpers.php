	...
	if ( preg_match( '/^(\d{1,2})\/12$/', $width, $match ) ) {
		...
		switch ( $width ) {
			...
			case "6/8" :
			  ...
			  break;
			case "2/8" :
			    $w = "sec_sidebar sidebar secondary-sidebar";
			  break;
			case "3/9" :
			    $w = "sidebar sidebar main-sidebar";
			  break;
			
			//left sidebar
			case "8/8" :
			      $w = "sidebar sidebar main-sidebar alignlefti";
			  break;
			case "7/7" :
			    $w = "main_col one_side alignrighti";
			    break;
			case "9/9" :
			    $w = "sec_sidebar sidebar secondary-sidebar alignlefti";
			    break;
