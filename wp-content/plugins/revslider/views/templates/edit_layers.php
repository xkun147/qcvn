...
-->
		...
		<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
			<h3 class="box-closed tp-accordion">
				<span><?php _e("Slide",REVSLIDER_TEXTDOMAIN) ?></span>
			</h3>
				...
				<div class="inner_wrapper p10 pb0 pt0 boxsized">
					...
					<div class="editor_buttons_wrapper_bottom">
						<div style="float:left">
							...
							<!--a href="javascript:void(0)" id="button_add_layer_static" class="button-primary revblue"><i class="revicon-layers-alt"></i><?php _e("Add Static Layer",REVSLIDER_TEXTDOMAIN)?> </a>
