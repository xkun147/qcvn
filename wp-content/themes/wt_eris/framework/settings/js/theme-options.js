jQuery(document).ready(function($){
	...
	jQuery('#wt_headings_color_selector').ColorPicker({													
		onChange: function (hsb, hex, rgb) {
				jQuery('#wt_headings_color_selector div').css('backgroundColor', '#' + hex);
				jQuery('#wt_headings_color').val('#'+hex);
		}
	});
	...
	jQuery('#wt_footer_headings_color_selector').ColorPicker({													
		onChange: function (hsb, hex, rgb) {
				jQuery('#wt_footer_headings_color_selector div').css('backgroundColor', '#' + hex);
				jQuery('#wt_footer_headings_color').val('#'+hex);
		}
	});
	
	jQuery('#wt_footer_text_color_selector').ColorPicker({													
		onChange: function (hsb, hex, rgb) {
				jQuery('#wt_footer_text_color_selector div').css('backgroundColor', '#' + hex);
				jQuery('#wt_footer_text_color').val('#'+hex);
		}
	});	
