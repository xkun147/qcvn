...
<?php } else {
    ...
    <?php if($time != 'off') { ?>
    <span class="current_time"><?php if ($clock_only != 1) { _e('GMT', 'theme'); echo $site_time; } ?> <?php $h ='h'; if ($time_format == 1) { $h = 'H'; } echo date("$h:i A", strtotime($site_time.' hours', time())); ?></span>
    <?php } ?>
    </div> <!--breaking news-->
<?php
