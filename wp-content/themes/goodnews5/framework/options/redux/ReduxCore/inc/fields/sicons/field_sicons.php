    ...
    class ReduxFramework_sicons extends ReduxFramework{
        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                echo '<input type="hidden" class="mom_icon_holder selected_icon" data-id="'.$x.'" id="selected-icon-'.$x.'" name="' . $this->field['name'] . '[' . $x . '][icon]" id="' . $this->field['id'] . '-selected_icon_' . $x . '" value="' . $icon['icon'] . '" /></li>';
