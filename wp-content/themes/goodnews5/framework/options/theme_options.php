	...
	$this->sections[] = array(
		...
		'fields' => array(
				...
				array (
					...
					'type' => 'switch',
					'default' => true,
					'title' => __('Header banner', $mom_textdomain),
				),
				array (
					'id' => 'header_banner_id',
					'type' => 'select',
	...
	$this->sections[] = array(
		...
		'fields' => array(
                    ...
                    array(
                        ...
                        'title'     => __('Select Tag', $mom_textdomain),
                    ),
                    ...
                    array (
                            ...
                            'type' => 'text',
                            'required'  => array('news_ticker_time', '=', 1),
...
#navigation ul.device-menu li.dm-active > a, #navigation .device-menu li.dm-active > .responsive-caret, .widget li:hover .cat_num, .news-ticker li i, .mom_breadcrumb .sep, .scrollToTop:hover', 'background' => '.mom-social-icons li a.vector_icon:hover, .owl-dot.active span, .feature-slider .fs-nav .selected', 'border-color' => '#comments .single-comment .comment-content .comment-reply-link:hover, #comments .single-comment .comment-content .comment-edit-link:hover, .post.sticky')
				),
                                array (
					'id' => 'headings_color',
					'type' => 'color',
	...
	$this->sections[] = array(
		...
		'fields' => array(
                    ...
                    array(
                        ...
                        'output'    => array('.navigation-inner, .search-wrap .search-results-title, .show_all_results, .search-wrap ul.s-results .s-img .post_format'),
                     ),
                    array(
                        'id'        => 'navigation_bd_cl',
                        'type'      => 'color',
...
'background-color' => '#navigation .main-menu > li .cats-mega-wrap .cats-mega-inner:before'),
                    ...
                    array(
                        ...
                        'line-height' => false,
                        'google' => true,
                        'output'    => array('#navigation .main-menu > li > a, #navigation .nav-search, .search-wrap ul.s-results .s-details h4, .search-wrap .search-results-title, .show_all_results a,  .ajax_search_results .sw-not_found'),
                     ),   
                    array(
                    ...
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => 'ul.main-menu > li.menu-item-has-children > a:after, ul.main-menu li:not(.mom_mega):not(.mom_mega_cats) ul.sub-menu li.menu-item-has-children > a:after, .search-wrap ul.s-results .s-details .mom-post-meta'),
                     ),                         
                    array(
                    ...
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '', 'background-color' => '#navigation .nav-search, .search-wrap .sw-inner, #navigation .nav-search.active:before'),
                     ),                    
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '#navigation .nav-search'),
                     ),
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '', 'background-color' => '.search-wrap .search-form input'),
                     ),
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '.search-wrap .search-form input'),
                     ),
                   array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '', 'background-color' => '.search-wrap .search-form .button'),
                     ),
                    array(
                        ...
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '.search-wrap .search-form .button'),
                     ),                              
                )
	); 
	...
	$this->sections[] = array(
		...
		'fields' => array(
                    ...
                    array(
                        ...
                        'title'     => __('borders', $mom_textdomain),
                        'subtitle'     => __('', $mom_textdomain),
                        'output'    => array('color' => '', 'border-color' => '.base-box, .sidebar .widget, .comment-form, div.bbp-template-notice, div.indicator-hint, #bbpress-forums fieldset.bbp-form legend, .scrolling-box:before, .news-box .older-articles ul.two-cols li, .news-box .older-articles ul li, .news-box .nb-footer, .nb-style3 .older-articles, .nb-style1 .nb1-older-articles ul.two-cols:before, .nb-style1 .recent-news, .sidebar .mom-posts-widget .mpw-post, .news-list .nl-item, .scrolling-box .owl-item, .mom-carousel .owl-wrapper, .sidebar .mom-recent-comments ul li, .blog-post .bp-head, .widget ul.twiter-list > li, .fs-image-nav .fs-prev, .fs-image-nav .fs-next, .fs-image-nav, .news-box .nb-header, .sidebar .widget .widget-head, .main_tabs .tabs li, .base-box .base-box, .tabs_v3 ul.tabs li, .tabs_v1 ul.tabs li, .tabs_v2 ul.tabs li, .tabs_v3 ul.tabs li, .main_tabs .tabs, .layout-boxed .base-box, .layout-boxed .sidebar .widget, .layout-boxed .comment-form, .layout-boxed div.bbp-template-notice, .layout-boxed div.indicator-hint, .layout-boxed #bbpress-forums fieldset.bbp-form legend',
