   ...
   <?php $mb->the_field('ad_type'); ?>
        <div class="mom_tiny_desc">
            <div class="mom_td_bubble">
                ...
                <span><?php _e('ad type can be image with url or code', 'framework'); ?></span>
            </div> <!--bubble-->
        </div> <!--desc-->
        <div class="mom_tiny_input">
			<select name="<?php $mb->the_name(); ?>" data-id="[<?php $mb->the_index(); ?>]" class="mom-ad-type">
			<option value=""<?php $mb->the_select_state(''); ?>><?php _e('Image', 'framework'); ?></option>
			<option value="code"<?php $mb->the_select_state('code'); ?>><?php _e('Code', 'framework'); ?></option>
		</select>
	...
	<input type="hidden" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" class="mom_preview_meta_input">
			...
			<option value=""<?php $mb->the_select_state(''); ?>><?php _e('Open in same window', 'framework'); ?></option>
			<option value="_blank"<?php $mb->the_select_state('_blank'); ?>><?php _e('Open in new window', 'framework'); ?></option>
                        </select>
                </div>
            </div> <!--mti_options-->
            ...
            <div class="mti_options_wrap mti_ad_code hide">
                <div class="mti_option">
                   <?php $mb->the_field('ad_code'); ?>
                    ...
                    <textarea type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('insert Ad code from any advertising Service e.g. google AdSense', 'framework'); ?>"><?php $mb->the_value(); ?></textarea>
                </div>
            </div> <!--mti_options-->
        </div> <!--input-->
        <div class="clear"></div>
    ...
    <div class="mom_tiny_form_element">
        ...
        <div class="mom_tiny_desc">
            <div class="mom_td_bubble">
                <label for="<?php $mb->the_name(); ?>"><?php _e('Expiration Date', 'framework'); ?></label>
                <span><?php _e('define when ad disappear from frontend', 'framework'); ?></span>
            </div> <!--bubble-->
        </div> <!--desc-->
        <div class="mom_tiny_input">
    ...
    <?php endwhile; ?>
    <a href="#" class="docopy-ads add-new-group-item button button-primary"><?php _e('Add new', 'framework') ?></a>
    </div>   <!--mom_meta_group-->
</div> <!--mom meta wrap-->
