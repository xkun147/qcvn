...
?>
		...
		<?php
			if ($orderby == 'popular') {
				if ($display == 'cats') {
					$catsi = implode(',', $cats);
					query_posts(array(  "ignore_sticky_posts" => 1, 'showposts' => $count, "orderby" => "comment_count", 'cat' => $catsi));
				} else {
				...
				if ($display == 'cats') {
					$catsi = implode(',', $cats);
					query_posts(array(  "ignore_sticky_posts" => 1, 'showposts' => $count, "orderby" => "rand", 'cat' => $catsi));
				} else {
				...
				if ($display == 'cats') {
					$catsi = implode(',', $cats);
					query_posts(array(  "ignore_sticky_posts" => 1, 'showposts' => $count, 'cat' => $catsi));
				} else {
