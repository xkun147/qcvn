<?php
function momizat_weather ($city, $units = 'metric', $date_format = 'm/d/Y',  $lang = 'en', $display='') {
...
$daily_weather_url = wp_remote_get('http://api.openweathermap.org/data/2.5/forecast/daily?q='.$city.'&mode=json&units='.$units.'&lang='.$lang.'&cnt=7');
                    ...
                    <div class="weather-widget">
                               ...
                               <div class="current-day-weather">
                                <div class="cdw-data border-box">
                                    ...
                                    <div class="cdw-meta"><span class="cd-date"><?php echo date('Md'); ?></span> <span class="cs-time"><?php echo date("h:i", strtotime($site_time.' hours', time())); ?></span></div>
                                    <ol>
...
?>
                                     <li>
                                        <div class="day-summary">
                                            <div class="d-date">
                                                <span class="dn"><?php echo $date->format('D'); ?></span>
                                                <span class="dd"><?php echo $date->format('Md'); ?></span>
                                            </div>
                                            <div class="d-decs">
